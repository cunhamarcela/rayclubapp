...
class _$ExerciseImpl implements _Exercise {
  ...
  @override
  String toString() {
    return 'Exercise(name: $name, description: $description, sets: $sets, reps: $reps, restSeconds: $restSeconds, imageUrl: $imageUrl, videoUrl: $videoUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, description, sets, reps,
      restSeconds, imageUrl, videoUrl);
