...
/// Provider para o repositório de estatísticas de treinos
final workoutStatsRepositoryProvider = Provider<WorkoutStatsRepository>((ref) {
  ...
  return MockWorkoutStatsRepository(recordRepository);
  
  // Quando estiver pronto para produção:
  // final supabase = Supabase.instance.client;
  // return SupabaseWorkoutStatsRepository(supabase, recordRepository);
}); 