...
class WorkoutFilterBar extends StatelessWidget {
  ...
  Widget _buildDurationFilter(BuildContext context) {
    ...
    final durationOptions = [0, 15, 30, 45, 60];
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final label = duration == 0 ? 'Qualquer duração' : '$duration min ou menos';
  ...
  Widget _buildDifficultyFilter(BuildContext context) {
    ...
    final difficulties = ['', 'Iniciante', 'Intermediário', 'Avançado'];
    final labels = ['Qualquer nível', 'Iniciante', 'Intermediário', 'Avançado'];
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected = currentFilter.difficulty == difficulty;
