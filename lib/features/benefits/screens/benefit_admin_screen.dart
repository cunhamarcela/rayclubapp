...
class _BenefitAdminScreenState extends ConsumerState<BenefitAdminScreen> with SingleTickerProviderStateMixin {
              ...
              children: [
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        redeemedBenefit.benefitSnapshot?.title ?? 'Benefício Desconhecido',
                        style: AppTypography.subtitle.copyWith(fontWeight: FontWeight.bold),
                      ),
                    ),
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                      onPressed: redeemedBenefit.status == RedemptionStatus.active ||
                               redeemedBenefit.status == RedemptionStatus.expired
                          ? () => _showEditRedeemedExpirationDialog(redeemedBenefit)
                          : null,
                      child: const Text('Editar Expiração'),
                    ),
                  ],
  ...
  Widget _getStatusChip(RedemptionStatus status) {
    Color color;
    String label;
  ...
  void _showEditRedeemedExpirationDialog(RedeemedBenefit redeemedBenefit) {
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                'Benefício: ${redeemedBenefit.benefitSnapshot?.title ?? "Desconhecido"}',
